...
def main(out_path: str) -> None:
    ...
    logger.info("Fetching PubMed abstracts for %d topics -> %s", len(TOPICS), out)
    ...
    logger.info("Done. %d abstracts written to %s (%d unique PMIDs)", total_written, out, len(seen_pmids))
